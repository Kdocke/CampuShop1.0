...
import com.kdocke.o2o.dao.ProductImgDao;
...
public class ProductServiceImpl implements ProductService {
	...
	/**
	 * 1.处理缩略图,获取缩略图的相对路径并赋值给 product 2.往 tb_product 写入商品信息,获取 productId 3.结合
	 * productId 批量处理商品详情图 4.将商品详情图列表批量插入 tb_product_img
	 */
	@Override
	@Transactional
	...
	private void addProductImgList(Product product, List<ImageHolder> productImgHolderList) {
		...
		// 遍历图片依次去处理,并添加进 productImg 实体类里
	...
	/**
	 * 1.若缩略图参数有值,则处理缩略图,若原先存在缩略图则先删除再添加新图,之后获取缩略图相对路径并赋值给 product
	 * 2.若商品详情图列表参数有值,对商品详情图列表进行同样的操作 3.将 tb_product_img 下面的该商品原先的商品详情图记录全部清除 4.更新
	 * tb_product_img以及tb_product 的信息
	 */
	@Override
	@Transactional
